...
var scripts = document.getElementsByTagName("script"),
  tarteaucitronPath =
    (document.currentScript || scripts[scripts.length - 1]).src.split("?")[0],
  tarteaucitronForceCDN = (tarteaucitronForceCDN === undefined)
    ? ""
    : tarteaucitronForceCDN,
  tarteaucitronUseMin = (tarteaucitronUseMin === undefined)
    ? ""
    : tarteaucitronUseMin,
  ...
  tarteaucitronForceLanguage = (tarteaucitronForceLanguage === undefined)
    ? ""
    : tarteaucitronForceLanguage,
  tarteaucitronForceExpire = (tarteaucitronForceExpire === undefined)
    ? ""
    : tarteaucitronForceExpire,
  tarteaucitronCustomText = (tarteaucitronCustomText === undefined)
    ? ""
    : tarteaucitronCustomText,
  // tarteaucitronExpireInDay: true for day(s) value - false for hour(s) value
  tarteaucitronExpireInDay = (tarteaucitronExpireInDay === undefined ||
...
var tarteaucitron = {
        ...
        if (tacAlertBig.style.display === "block") {
          ...
          if (scrollPos > (screen.height * 2)) {
            ...
            document.getElementById("tarteaucitronDisclaimerAlert").innerHTML =
              "<strong>" + tarteaucitron.lang.alertBigScroll + "</strong> " +
  ...
  "load": function () {
    ...
    var cdn = tarteaucitron.cdn,
      ...
      useMinifiedJS =
        ...
        (tarteaucitronUseMin !== ""),
      pathToLang = cdn + "lang/tarteaucitron." + language +
        (useMinifiedJS ? ".min" : "") + ".js",
      pathToServices = cdn + "tarteaucitron.services" +
        (useMinifiedJS ? ".min" : "") + ".js",
      ...
      window.addEventListener("tac.root_available", function () {
        setTimeout(function () {
          ...
          window.dataLayer.push({
            ...
            tacAuthorizedVendors: tarteaucitron.job.filter((job) =>
              tarteaucitron.state[job] === true
            ),
          });
        }, 200);
      });
    ...
    if (!tarteaucitron.parameters.useExternalCss) {
      ...
      linkElement.href = cdn + "css/tarteaucitron" +
        (useMinifiedJS ? ".min" : "") + ".css";
      ...
      tarteaucitron.addInternalScript(pathToServices, "", function () {
        ...
        if (tarteaucitron.orientation === "popup") {
          var customThemePopup = document.createElement("style"),
            cssRulePopup = "div#tarteaucitronAlertBig:before {content: '" +
              tarteaucitron.lang.middleBarHead +
        ...
        html +=
          ...
          tarteaucitron.lang.title + "</div>";
        html += '<div id="tarteaucitronPremium"></div>';
        if (tarteaucitron.reloadThePage) {
          html += '<button type="button" id="tarteaucitronBack" aria-label="' +
            tarteaucitron.lang.close + " (" + tarteaucitron.lang.reload +
            ')" title="' + tarteaucitron.lang.close + " (" +
            tarteaucitron.lang.reload + ')"></button>';
        } else {
          html += '<button type="button" id="tarteaucitronBack" aria-label="' +
            tarteaucitron.lang.close + '" title="' + tarteaucitron.lang.close +
            '"></button>';
        }
        html +=
        ...
        html += '            <button aria-label="' + tarteaucitron.lang.icon +
        ...
        if (tarteaucitron.parameters.mandatory == true) {
          ...
          if (tarteaucitron.parameters.showDetailsOnClick) {
            html +=
              ...
              tarteaucitron.lang.mandatoryTitle + "</button>";
          } else {
            html += '   <span class="asCatToggleBtn">' +
              tarteaucitron.lang.mandatoryTitle + "</span>";
          }
          html += "</div>";
          ...
          html +=
            ...
            tarteaucitron.lang.mandatoryText + "</span>";
          html +=
        ...
        for (i = 0; i < cat.length; i += 1) {
          html += '         <li id="tarteaucitronServicesTitle_' + cat[i] +
          ...
          if (tarteaucitron.parameters.showDetailsOnClick) {
            html +=
              ...
              tarteaucitron.lang[cat[i]].title + "</button>";
          } else {
            html +=
              '               <span class="asCatToggleBtn" data-cat="tarteaucitronInlineDetails' +
              cat[i] + '">' + tarteaucitron.lang[cat[i]].title + "</span>";
          }
          html += "            </div>";
          html += '            <div id="tarteaucitronDetails' + cat[i] +
          ...
          html += "            </div>";
          html += '         <ul id="tarteaucitronServices_' + cat[i] +
            '"></ul></li>';
        }
        html +=
          '             <li id="tarteaucitronNoServicesTitle" class="tarteaucitronLine">' +
          tarteaucitron.lang.noServices + "</li>";
        html += "         </ul>";
        html +=
        ...
        if (
          ...
          html +=
            ...
            tarteaucitron.lang.modalWindow + '" title="' +
            tarteaucitron.lang.personalize + " " +
          ...
          if (tarteaucitron.parameters.highPrivacy) {
            ...
            html += "       " + tarteaucitron.lang.alertBigClick + " " +
              tarteaucitron.lang.alertBig;
          }
          ...
          if (tarteaucitron.parameters.DenyAllCta) {
            if (tarteaucitron.reloadThePage) {
              html +=
                ...
                tarteaucitron.lang.icon + " : " + tarteaucitron.lang.denyAll +
                " (" + tarteaucitron.lang.reload + ')" title="' +
        ...
        if (tarteaucitron.parameters.showIcon === true) {
          html += '<div id="tarteaucitronIcon" class="tarteaucitronIcon' +
            tarteaucitron.parameters.iconPosition + '">';
          html +=
            '   <button type="button" id="tarteaucitronManager" aria-label="' +
            tarteaucitron.lang.icon + " " + tarteaucitron.lang.modalWindow +
            '" title="' + tarteaucitron.lang.icon + " " +
            tarteaucitron.lang.modalWindow + '">';
          html += '       <img src="' + (tarteaucitron.parameters.iconSrc
        ...
        tarteaucitron.addInternalScript(
          tarteaucitron.cdn + "advertising" + (useMinifiedJS ? ".min" : "") +
            ".js",
          "",
          function () {
            if (
        ...
        if (tarteaucitron.parameters.adblocker === true) {
          setTimeout(function () {
            if (tarteaucitronNoAdBlocker === false) {
              ...
              html += "       <strong>" + tarteaucitron.lang.adblock_call +
                "</strong>";
              html += "   </p>";
              html +=
          ...
          setTimeout(function () {
            ...
            if (closeElement) {
              closeButton.innerHTML =
                ...
                tarteaucitron.lang.closeBanner + "</span>";
        ...
        if (tarteaucitron.parameters.groupServices === true) {
          ...
          Array.prototype.forEach.call(cats, function (item) {
            var cat = item.getAttribute("id").replace(
            ...
            if (cat !== "mandatory") {
              ...
              html +=
                ...
                tarteaucitron.lang[cat].title + "</span>";
              html += "       <span>" + tarteaucitron.lang[cat].details +
                "</span>";
              html +=
                '   <button type="button" aria-expanded="false" class="tarteaucitron-toggle-group" id="tarteaucitron-toggle-group-' +
                cat + '">' + tarteaucitron.lang.alertSmall +
                ' <span id="tarteaucitronCounter-' + cat + '"></span></button>';
              html += "   </div>";
              html +=
                '   <div class="tarteaucitronAsk" id="tarteaucitron-group-' +
                cat + '">';
              html += '       <button type="button" aria-label="' +
                tarteaucitron.lang.allow + " " + tarteaucitron.lang[cat].title +
              ...
              html += "       </button> ";
              html += '       <button type="button" aria-label="' +
                tarteaucitron.lang.deny + " " + tarteaucitron.lang[cat].title +
              ...
              document.querySelector("#tarteaucitronServices_" + cat).style
                .display = "none";
              tarteaucitron.addClickEventToId(
                ...
                function () {
                  ...
                  if (
                    ...
                    document.getElementById("tarteaucitron-toggle-group-" + cat)
          ...
          if (tacSaveButtonParent !== null) {
            tacSaveButtonParent.insertAdjacentHTML(
              ...
              '<div id="tarteaucitronSave"><button class="tarteaucitronAllow" id="tarteaucitronSaveButton">' +
                tarteaucitron.lang.save + "</button></div>",
            );
          }
        }, 100);
  ...
  "addService": function (serviceId) {
    ...
    var cookie = tarteaucitron.cookie.read(),
      ...
      isResponded = cookie.indexOf(service.key + "=false") >= 0 ||
      ...
      state = (undefined !== service.defaultState)
    ...
    if (tarteaucitron.added[service.key] !== true) {
      ...
      html += '          <span class="tacCurrentStatus" id="tacCurrentStatus' +
        service.key + '">' + currentStatus + "</span>";
      html +=
        '          <span class="tarteaucitronReadmoreSeparator"> - </span>';
      html += '          <span id="tacCL' + service.key +
      ...
      if (tarteaucitron.parameters.moreInfoLink == true) {
        ...
        html += '       <a href="' + link +
          ...
          tarteaucitron.lang.more + " : " + tarteaucitron.lang.cookieDetail +
          " " + service.name + " " + tarteaucitron.lang.ourSite + " " +
          tarteaucitron.lang.newWindow +
          '" class="tarteaucitronReadmoreInfo">' + tarteaucitron.lang.more +
          "</a>";
        html +=
          '       <span class="tarteaucitronReadmoreSeparator"> - </span>';
        html += '       <a href="' + service.uri +
          '" target="_blank" rel="noreferrer noopener" title="' +
          tarteaucitron.lang.source + " " + service.name + " " +
          tarteaucitron.lang.newWindow +
      ...
      html += '   <div class="tarteaucitronAsk">';
      html += '       <button type="button" aria-label="' +
        tarteaucitron.lang.allow + " " + service.name + '" id="' + service.key +
      ...
      html += "       </button> ";
      html += '       <button type="button" aria-label="' +
        tarteaucitron.lang.deny + " " + service.name + '" id="' + service.key +
    ...
    if (
      (!isResponded && (isAutostart || (isNavigating && isWaiting)) &&
        !tarteaucitron.highPrivacy) || isAllowed
    ) {
      if (
        !isAllowed ||
        (!service.needConsent && cookie.indexOf(service.key + "=false") < 0)
  ...
  "userInterface": {
    "css": function (id, property, value) {
      ...
      if (document.getElementById(id) !== null) {
        if (
          ...
          (id == "tarteaucitron" || id == "tarteaucitronBack" ||
        ...
        if (tarteaucitron.state[key] !== status) {
          if (status === false && tarteaucitron.launch[key] === true) {
            ...
            if (tarteaucitron.checkIfExist("tarteaucitronClosePanel")) {
              var ariaCloseValue =
                document.getElementById("tarteaucitronClosePanel").textContent
                  .trim() + " (" + tarteaucitron.lang.reload + ")";
              document.getElementById("tarteaucitronClosePanel").setAttribute(
                "aria-label",
                ariaCloseValue,
              );
              document.getElementById("tarteaucitronClosePanel").setAttribute(
    ...
    "color": function (key, status) {
      ...
      if (key !== "") {
        if (status === true) {
          ...
          document.getElementById(key + "Allowed").setAttribute(
            "aria-pressed",
            "true",
          );
          document.getElementById(key + "Denied").setAttribute(
            "aria-pressed",
            "false",
          );
        } else if (status === false) {
        ...
        if (nbDenied === 0 && nbPending === 0) {
          ...
          document.getElementById(c + "AllDenied").setAttribute(
            "aria-pressed",
            "false",
          );
          document.getElementById(c + "AllAllowed").setAttribute(
            "aria-pressed",
            "true",
          );
        ...
        if (
          tarteaucitron.services[key].cookies.length > 0 && status === false
        ) {
      ...
      Array.prototype.forEach.call(cats, function (item) {
        ...
        if (total === groupallowed) {
          ...
          if (document.getElementById("tarteaucitron-reject-group-" + cat)) {
            ...
            document.getElementById("tarteaucitron-accept-group-" + cat)
    ...
    "closePanel": function () {
      ...
      if (
        ...
        document.getElementById("tarteaucitronCookiesNumber").setAttribute(
          "aria-expanded",
          "false",
        );
        tarteaucitron.userInterface.css(
    ...
    "focusTrap": function (parentElement) {
      ...
      focusableEls = document.getElementById(parentElement).querySelectorAll(
        "a[href], button",
      );
      filtered = [];
    ...
    "jsSizing": function (type) {
      ...
      if (type === "box") {
        if (
          ...
          cookiesNumberHeight =
            document.getElementById("tarteaucitronCookiesNumber").offsetHeight;
        ...
        if (
          ...
          closeButtonHeight =
            document.getElementById("tarteaucitronClosePanel").offsetHeight;
        ...
        if (
          ...
          scrollbarWidthChild =
            document.getElementById("tarteaucitronScrollbarChild").offsetWidth;
        ...
        if (document.getElementById("tarteaucitron") !== null) {
          ...
          if (e[a + "Width"] <= 767) {
            ...
            mainTop = ((windowInnerHeight -
              document.getElementById("tarteaucitron").offsetHeight) / 2) -
              21;
          }
        ...
        if (
          ...
          cookiesListHeight =
            document.getElementById("tarteaucitronCookiesListContainer")
              .offsetHeight;
          cookiesCloseHeight =
            document.getElementById("tarteaucitronClosePanelCookie")
              .offsetHeight;
          cookiesTitleHeight =
            document.getElementById("tarteaucitronCookiesTitle").offsetHeight;

          // apply
          tarteaucitron.userInterface.css(
            "tarteaucitronCookiesList",
            "height",
            (cookiesListHeight - cookiesCloseHeight - cookiesTitleHeight - 2) +
              "px",
          );
        }
      }
  ...
  "cookie": {
    ...
    "create": function (key, status) {
      ...
      var d = new Date(),
        ...
        value = tarteaucitron.parameters.cookieName + "=" + cookie + "!" + key +
          "=" + status,
        domain = (tarteaucitron.parameters.cookieDomain !== undefined &&
    ...
    "checkCount": function (key) {
      ...
      if (status >= 0 && nb === 0) {
        ...
        if (nbCurrent > 0) {
          html += tarteaucitron.lang.useCookieCurrent + " " + nbCurrent + " " +
            cookieLabel;
          if (nbCurrent > 1) {
            html += "s";
          }
    ...
    "number": function () {
      ...
      var cookies = document.cookie.split(";"),
        ...
        savedname,
        regex = /^https?\:\/\/([^\/?#]+)(?:[\/?#]|$)/i,
        regexedDomain = (tarteaucitron.cdn.match(regex) !== null)
          ? tarteaucitron.cdn.match(regex)[1]
          : tarteaucitron.cdn,
        host = (tarteaucitron.domain !== undefined)
      ...
      cookies = cookies.sort(function (a, b) {
        ...
        c = (tarteaucitron.cookie.owner[namea] !== undefined)
          ? tarteaucitron.cookie.owner[namea]
          : "0";
        d = (tarteaucitron.cookie.owner[nameb] !== undefined)
      ...
      if (document.cookie !== "") {
        for (i = 0; i < nb; i += 1) {
          ...
          if (
            ...
            html +=
              '     <span class="tarteaucitronTitle tarteaucitronH3" role="heading" aria-level="4">';
            html += "        " + tarteaucitron.cookie.owner[name].join(" // ");
            html += "    </span>";
            html += '</div><ul class="cookie-list">';
          } else if (
            tarteaucitron.cookie.owner[name] === undefined && host !== savedname
          ) {
            savedname = host;
            html += '<div class="tarteaucitronHidden">';
            html +=
          ...
          html +=
            ...
            tarteaucitron.fixSelfXSS(name) + "</strong>";
          html += "    </div>";
          html += '    <div class="tarteaucitronCookiesListRight">' +
  ...
  "fixSelfXSS": function (html) {
    return html.toString().replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(
      />/g,
      "&gt;",
    ).replace(/"/g, "&quot;").replace(/'/g, "&#039;");
  },
  ...
  "makeAsync": {
    ...
    "execJS": function (id) {
      ...
      for (i = 0; i < scripts.length; i += 1) {
        type = (scripts[i].getAttribute("type") !== null)
          ? scripts[i].getAttribute("type")
          : "";
        if (type === "") {
          type = (scripts[i].getAttribute("language") !== null)
        ...
        if (
          ...
          document.getElementById(id).innerHTML += '<div id="' + childId +
            '"></div>';
  ...
  "engage": function (id) {
    ...
    var html = "",
      ...
      engage = tarteaucitron.services[id].name + " " +
    ...
    html += "      " + engage;
    html += '      <button aria-label="' + tarteaucitron.lang.allow + " " +
      tarteaucitron.services[id].name +
      '" type="button" class="tarteaucitronAllow" id="Eng' + r + "ed" + id +
      '">';
    html +=
      '          <span class="tarteaucitronCheck" aria-hidden="true"></span> ' +
      tarteaucitron.lang.allow;
  ...
  "proPing": function () {
    "use strict";
    if (
      tarteaucitron.uuid !== "" && tarteaucitron.uuid !== undefined &&
      tarteaucitron.proTemp !== "" && tarteaucitronStatsEnabled
    ) {
  ...
  "getElemAttr": function (elem, attr) {
    var attribute = elem.getAttribute("data-" + attr) ||
