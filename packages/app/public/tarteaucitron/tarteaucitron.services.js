...
tarteaucitron.services.iframe = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_iframe"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" src="' + url + '" style="' +
        styleAttr + '" allowtransparency' + (allowfullscreen == "0"
          ? ""
...
tarteaucitron.services.dialoginsight = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://t.ofsys.com/js/Journey/1/" + tarteaucitron.user.dialogInsightId +
        "/DI.Journey-min.js",
    );
  },
};
...
tarteaucitron.services.reddit = {
  ...
  "name": "Reddit",
  "uri":
    "https://business.reddithelp.com/helpcenter/s/article/Reddit-Advertising-Policy-Overview",
  "needConsent": true,
  "cookies": [],
  "js": function () {
    "use strict";
...
tarteaucitron.services.equativ = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://ced.sascdn.com/tag/" + tarteaucitron.user.equativId +
        "/smart.js",
    );
  },
};
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["twitch_player"], function (x) {
      var frame_title = (tarteaucitron.getElemAttr(x, "title"))
        ...
        width = tarteaucitron.getElemAttr(x, "width"),
        height = tarteaucitron.getElemAttr(x, "height");
      var embedURL = "https://player.twitch.tv/?video=" + id + "&parent=" +
        parent;
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        '" src="' + embedURL + '"></iframe>';
    });
  },
  "fallback": function () {
...
tarteaucitron.services.playplay = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_playplay"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        'border:0;" src="' + playURL + '" allowfullscreen></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.adobeworkspace = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://assets.adobedtm.com/" + tarteaucitron.user.adobeworkspaceId1 +
        "/" + tarteaucitron.user.adobeworkspaceId2 + "/launch-" +
        tarteaucitron.user.adobeworkspaceId3 + ".min.js",
    );
  },
};
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://cdn-eu.pagesense.io/js/" +
        ...
        tarteaucitron.user.zohoPageSenseScriptHash + ".js",
    );
  },
};
...
tarteaucitron.services.force24 = {
  ...
  "name": "Force24",
  "uri":
    "https://support.force24.co.uk/support/solutions/articles/79000128057-cookie-policies",
  "needConsent": true,
...
tarteaucitron.services.activecampaignvgo = {
  ...
  "js": function () {
    ...
    window[window.visitorGlobalObjectAlias] =
      window[window.visitorGlobalObjectAlias] || function () {
...
tarteaucitron.services.eulerian = {
  ...
  "js": function () {
    ...
    (function (e, a) {
      ...
      y = i % 26;
      o.async = 1;
      o.src = "//" + e + "/" + String.fromCharCode(97 + y, 122 - y, 65 + y) +
        (i % 1E3) + ".js?2";
...
tarteaucitron.services.kwanko = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_kwanko"], function (x) {
      ...
      return '<img src="https://action.metaffiliation.com/trk.php?mclic=' +
        mclic + '" width="1" height="1" />';
    });
  },
  "fallback": function () {
    "use strict";
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://secure.team8save.com/js/sc/" +
        tarteaucitron.user.leadforensicsId + ".js",
    );
  },
};
...
tarteaucitron.services.ubib = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://" + tarteaucitron.user.ubibId +
        ".libanswers.com/load_chat.php?hash=" + tarteaucitron.user.ubibHash,
    );
  },
};
...
tarteaucitron.services.robofabrica = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      ...
      "inceptive-cw-script",
      function () {
        document.getElementById("inceptive-cw-script").setAttribute(
          "unique-url",
...
tarteaucitron.services.videas = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_videas"], function (x) {
      ...
      return '<iframe title="' + frame_title +
        '" src="https://app.videas.fr/embed/' + id + '/" style="' + styleAttr +
        '" allowtransparency ' + (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
    });
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://actorssl-5637.kxcdn.com/actor/" +
        tarteaucitron.user.myfeelbackId + "/action",
      "MFBActor",
    );
  },
};
...
tarteaucitron.services.doubleclick = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["doubleclick_container"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" src="https://' + id1 +
        ".fls.doubleclick.net/activityi;src=" + id2 + ";type=" + type +
        ";cat=" + cat + ";item=" + item + ";quantity=" + quantity + ";price=" +
        price + ";postage=" + postage + ";seller=" + seller + ";gdpr=" + gdpr +
        ";gdpr_consent=" + gdpr_consent + ";num=" + num + ";ord=" + ord +
...
tarteaucitron.services.piwikpro = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://" + tarteaucitron.user.piwikProContainer +
        ".containers.piwik.pro/" + tarteaucitron.user.piwikProId + ".js" +
        qPString,
    );
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://brain.plezi.co/api/v1/analytics?tenant=" +
        tarteaucitron.user.pleziTenant + "&tw=" + tarteaucitron.user.pleziTw,
    );
  },
};
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["xandrsegment-canvas"], function (x) {
      ...
      return '<div id="' + uniqId + '" xandrsegmentAdd="' +
        ...
        '" xandrsegmentOther="' +
        tarteaucitron.getElemAttr(x, "xandrsegmentOther") + '"></div>';
    });
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      document.getElementById(uniqIds[i]).innerHTML = "<img src='" + uri +
        "' width='1' height='1' />";
    }
  },
  "fallback": function () {
...
tarteaucitron.services.xandrconversion = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["xandrconversion-canvas"], function (x) {
      var uniqId = "_" + Math.random().toString(36).substr(2, 9);
      uniqIds.push(uniqId);
      return '<div id="' + uniqId + '" xandrconversionId="' +
        ...
        tarteaucitron.getElemAttr(x, "xandrconversionOther") + '"></div>';
    });
...
tarteaucitron.services.helloasso = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_helloasso"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" id="haWidget" src="' + url +
        '" style="' + styleAttr + '" allowtransparency ' +
        (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_facebookpost"], function (x) {
      ...
      return '<iframe title="' + frame_title +
        ...
        encodeURIComponent(url) + "&amp;width=" + width +
        "&amp;show_text=false&amp;appId=" + appId + "&amp;show_text=" +
        showText + "&amp;height=" + height + '" style="' + styleAttr +
        '" allowtransparency ' + (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
    ...
    window.AdUpRetargeting = function (api) {
      for (var i = 0; i < elements.length; i++) {
        ...
        if (tarteaucitron.getElemAttr(element, "device")) {
          var setter = "set" +
            tarteaucitron.getElemAttr(element, "device").charAt(0)
              .toUpperCase() +
        ...
        if (tarteaucitron.getElemAttr(element, "track")) {
          var tracker = "track" +
            tarteaucitron.getElemAttr(element, "track").charAt(0)
              .toUpperCase() +
...
tarteaucitron.services.amazon = {
  ...
  "name": "Amazon",
  "uri":
    "https://www.amazon.com/gp/help/customer/display.html/?ie=UTF8&nodeId=201909010",
  "needConsent": true,
  "cookies": [],
  "js": function () {
    "use strict";
    tarteaucitron.fallback(["amazon_product"], function (x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") ||
        ...
        url =
          ...
          "&source=ss&ref=ss_til&ad_type=product_link&tracking_id=" + amazonId +
          "&marketplace=amazon&region=" +
          tarteaucitron.getLanguage().toUpperCase() + "&placement=" +
          productId + "&asins=" + productId +
          "&show_border=true&link_opens_in_new_window=true",
        iframe = '<iframe title="' + frame_title +
          '" style="width:120px;height:240px;" src="' + url + '"></iframe>';
...
tarteaucitron.services.clicmanager = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["clicmanager-canvas"], function (x) {
      var uniqId = "_" + Math.random().toString(36).substr(2, 9);
      uniqIds.push(uniqId);
      return '<div id="' + uniqId + '" c="' +
        tarteaucitron.getElemAttr(x, "c") + '" s="' +
        tarteaucitron.getElemAttr(x, "s") + '" t="' +
        tarteaucitron.getElemAttr(x, "t") + '"></div>';
    });
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "//script.crazyegg.com/pages/scripts/" +
        ...
        tarteaucitron.user.crazyeggId.substr(4, 4) + ".js",
    );
  },
};
...
tarteaucitron.services.criteo = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["criteo-canvas"], function (x) {
      var uniqId = "_" + Math.random().toString(36).substr(2, 9);
      uniqIds.push(uniqId);
      return '<div id="' + uniqId + '" zoneid="' +
        tarteaucitron.getElemAttr(x, "zoneid") + '"></div>';
    });
    ...
    for (i = 0; i < uniqIds.length; i += 1) {
      ...
      uri += document.charset !== undefined
        ? "&charset=" + document.charset
        : "";
      uri += document.characterSet !== undefined
        ? "&charset=" + document.characterSet
        : "";
      uri += (document.referrer !== undefined)
        ? "&referer=" + encodeURI(document.referrer)
        : "";
      uri += (document.context !== undefined)
        ? "&context=" + encodeURI(document.context)
        : "";
      uri += ((document.MAX_ct0 !== undefined) &&
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["artetv_player"], function (x) {
      ...
      video_frame = '<iframe title="' + frame_title + '" style="' + styleAttr +
        ...
        video_json + '" ' + (video_allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
      return video_frame;
...
tarteaucitron.services.dailymotion = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["dailymotion_player"], function (x) {
      ...
      if (
        embed_type === undefined || !["video", "playlist"].includes(embed_type)
      ) {
        embed_type = "video";
      }
      video_frame = '<iframe title="' + frame_title +
        '" src="//www.dailymotion.com/embed/' + embed_type + "/" + video_id +
        "?" + params + '" style="' + styleAttr + '" ' + (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
      return video_frame;
...
tarteaucitron.services.datingaffiliation = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["datingaffiliation-canvas"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" src="' + url + "&r=" + r +
        "&p=" + p + "&cf0=" + cf0 + "&langue=" + langue +
        "&forward_affiliate=" + forward_affiliate + "&cf2=" + cf2 + "&cfsa2=" +
        cfsa2 + '" style="' + styleAttr + '"></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.datingaffiliationpopup = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["datingaffiliationpopup-canvas"], function (x) {
      var uniqId = "_" + Math.random().toString(36).substr(2, 9);
      uniqIds.push(uniqId);
      return '<div id="' + uniqId + '" uri="' +
        tarteaucitron.getElemAttr(x, "uri") + '" comfrom="' +
        tarteaucitron.getElemAttr(x, "comfrom") + '" promo="' +
        tarteaucitron.getElemAttr(x, "promo") + '" productid="' +
        tarteaucitron.getElemAttr(x, "productid") + '" submitconfig="' +
        tarteaucitron.getElemAttr(x, "submitconfig") + '" ur="' +
        tarteaucitron.getElemAttr(x, "ur") + '" brand="' +
        tarteaucitron.getElemAttr(x, "brand") + '" lang="' +
        tarteaucitron.getElemAttr(x, "lang") + '" cf0="' +
        tarteaucitron.getElemAttr(x, "cf0") + '" cf2="' +
        tarteaucitron.getElemAttr(x, "cf2") + '" subid1="' +
        tarteaucitron.getElemAttr(x, "subid1") + '" cfsa2="' +
        tarteaucitron.getElemAttr(x, "cfsa2") + '" subid2="' +
        tarteaucitron.getElemAttr(x, "subid2") + '" nicheid="' +
        tarteaucitron.getElemAttr(x, "nicheid") + '" degreid="' +
        tarteaucitron.getElemAttr(x, "degreid") + '" bt="' +
        tarteaucitron.getElemAttr(x, "bt") + '" vis="' +
        tarteaucitron.getElemAttr(x, "vis") + '" hid="' +
        tarteaucitron.getElemAttr(x, "hid") + '" snd="' +
        tarteaucitron.getElemAttr(x, "snd") + '" aabd="' +
        tarteaucitron.getElemAttr(x, "aabd") + '" aabs="' +
        tarteaucitron.getElemAttr(x, "aabs") + '"></div>';
    });
...
tarteaucitron.services.deezer = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["deezer_player"], function (x) {
      ...
      deezer_frame = '<iframe title="' + frame_title +
        '" src="//widget.deezer.com/widget/' + embed_theme + "/" + embed_type +
        "/" + deezer_id + "?" + params + '" style="' + styleAttr + '" ' +
        (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "//secure.leadforensics.com/js/" +
        tarteaucitron.user.leadforensicsIidentifier + ".js",
    );
  },
};
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "//connect.ekomi.de/integration_1410173009/" +
        tarteaucitron.user.ekomiCertId + ".js",
    );
  },
};
...
tarteaucitron.services.facebook = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "//connect.facebook.net/" + tarteaucitron.getLocale() +
...
tarteaucitron.services.pingdom = {
  ...
  "js": function () {
    ...
    window._prum = [["id", tarteaucitron.user.pingdomId], [
      "mark",
      "firstbyte",
      (new Date()).getTime(),
    ]];
...
tarteaucitron.services.adsensesearchresult = {
  ...
  "fallback": function () {
    ...
    if (document.getElementById("gcse_searchresults")) {
      document.getElementById("gcse_searchresults").innerHTML = tarteaucitron
        .engage(id);
    }
  },
};
...
tarteaucitron.services.genially = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_genially"], function (x) {
      ...
      return '<div style="position: relative; padding-bottom: 109.00%; padding-top: 0; height: 0;"><iframe style="position: absolute; top: 0; left: 0;' +
        styleAttr + '" title="' + frame_title +
        '" src="https://view.genial.ly/' + geniallyid + '" allowtransparency ' +
        (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe></div>";
...
tarteaucitron.services.googlemaps = {
  ...
  "js": function () {
    ...
    if (tarteaucitron.user.googlemapsLibraries) {
      googleMapsLibraries = "&libraries=" +
        tarteaucitron.user.googlemapsLibraries;
    }

    tarteaucitron.addScript(
      "//maps.googleapis.com/maps/api/js?v=3.exp&key=" +
        tarteaucitron.user.googlemapsKey + "&callback=" +
        tarteaucitron.user.mapscallback + googleMapsLibraries,
    );
    ...
    window.tac_googlemaps_callback = function () {
      tarteaucitron.fallback(["googlemaps-canvas"], function (x) {
        var uniqId = "_" + Math.random().toString(36).substr(2, 9);
        uniqIds.push(uniqId);
        return '<div id="' + uniqId + '" zoom="' +
          tarteaucitron.getElemAttr(x, "zoom") + '" latitude="' +
          tarteaucitron.getElemAttr(x, "latitude") + '" longitude="' +
          tarteaucitron.getElemAttr(x, "longitude") + '" style="width:' +
          tarteaucitron.getStyleSize(x.offsetWidth) + ";height:" +
          tarteaucitron.getStyleSize(x.offsetHeight) + '"></div>';
      });
...
tarteaucitron.services.googlemapssearch = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["googlemapssearch"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        'border:0" src="https://www.google.com/maps/embed/v1/place?q=' + query +
        "&key=" + key + '" allowfullscreen></iframe> ';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.googlemapsembed = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["googlemapsembed"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" src="' + url + '" style="' +
        styleAttr + '" allowtransparency allowfullscreen></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.openstreetmap = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["openstreetmap"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" src="' + url + '" style="' +
        styleAttr + '" allowfullscreen></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.instagram = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["instagram_post"], function (x) {
      ...
      post_frame = '<iframe title="' + frame_title +
        '" src="//www.instagram.com/p/' + post_id + '/embed" style="' +
        styleAttr + '"></iframe>';
...
tarteaucitron.services.recaptcha = {
  ...
  "js": function () {
    "use strict";
    window.tacRecaptchaOnLoad = tarteaucitron.user.recaptchaOnLoad ||
      function () {};
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "//flex.atdmt.com/mstag/site/" +
        tarteaucitron.user.microsoftcampaignanalyticsUUID + "/mstag.js",
      "mstag_tops",
      function () {
        window.mstag = {
          loadTag: function () {},
...
tarteaucitron.services.prelinker = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["prelinker-canvas"], function (x) {
      var uniqId = "_" + Math.random().toString(36).substr(2, 9);
      uniqIds.push(uniqId);
      return '<div id="' + uniqId + '" siteId="' +
        tarteaucitron.getElemAttr(x, "siteId") + '" bannerId="' +
        tarteaucitron.getElemAttr(x, "bannerId") + '" defaultLanguage="' +
        tarteaucitron.getElemAttr(x, "defaultLanguage") + '" tracker="' +
        tarteaucitron.getElemAttr(x, "tracker") + '"></div>';
    });
...
tarteaucitron.services.pubdirecte = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["pubdirecte-canvas"], function (x) {
      var uniqId = "_" + Math.random().toString(36).substr(2, 9);
      uniqIds.push(uniqId);
      return '<div id="' + uniqId + '" pid="' +
        tarteaucitron.getElemAttr(x, "pid") + '" ref="' +
        tarteaucitron.getElemAttr(x, "ref") + '"></div>';
    });
...
tarteaucitron.services.rumbletalk = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["rumbletalk"], function (x) {
      ...
      return '<div style="height: ' + tarteaucitron.getStyleSize(height) +
        "; width: " + tarteaucitron.getStyleSize(width) + ';"><div id="' + id +
        '"></div></div>';
    });
  },
  "fallback": function () {
...
tarteaucitron.services.shareasale = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["shareasale-canvas"], function (x) {
      var uniqId = "_" + Math.random().toString(36).substr(2, 9);
      uniqIds.push(uniqId);
      return '<div id="' + uniqId + '" amount="' +
        tarteaucitron.getElemAttr(x, "amount") + '" tracking="' +
        tarteaucitron.getElemAttr(x, "tracking") + '" transtype="' +
        tarteaucitron.getElemAttr(x, "transtype") + '" persale="' +
        tarteaucitron.getElemAttr(x, "persale") + '" perlead="' +
        tarteaucitron.getElemAttr(x, "perlead") + '" perhit="' +
        tarteaucitron.getElemAttr(x, "perhit") + '" merchantID="' +
        tarteaucitron.getElemAttr(x, "merchantID") + '"></div>';
    });
...
tarteaucitron.services.soundcloud = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["soundcloud_player"], function (x) {
      ...
      var qs = "?url=https%3A//api.soundcloud.com/" + playable_type + "/" +
        playable_id;
      ...
      return '<iframe title="' + frame_title + '" style="width:100%;' +
        frame_height + '" ' + allowAutoplay +
        ' src="https://w.soundcloud.com/player/' + qs + '"></iframe>';
    });
  },
  fallback: function () {
    "use strict";
...
tarteaucitron.services.spotify = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["spotify_player"], function (x) {
      ...
      spotify_frame = '<iframe title="' + frame_title +
        '" src="//open.spotify.com/embed/' + spotify_id + '" style="' +
        styleAttr + '" allowfullscreen></iframe>';
    ...
    tarteaucitron.fallback(["timelinejs-canvas"], function (x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") ||
        ...
        url =
          ...
          spreadsheet_id + "&font=" + font + "&maptype=" + map + "&lang=" +
          lang + "&start_at_end=" + start_at_end + "&hash_bookmark=" +
          hash_bookmark + "&start_at_slide=" + start_at_slide +
          "&start_zoom_adjust=" + start_zoom + "&height=" + height;
...
tarteaucitron.services.tagcommander = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://cdn.tagcommander.com/" + tarteaucitron.user.tagcommanderid +
        ".js",
    );
  },
};
...
tarteaucitron.services.twenga = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "//tracker.twenga." + tarteaucitron.user.twengaLocale + "/st/tracker_" +
        tarteaucitron.user.twengaId + ".js",
    );
  },
};
...
tarteaucitron.services.vimeo = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["vimeo_player"], function (x) {
      ...
      video_frame = '<iframe title="' + frame_title +
        '" src="//player.vimeo.com/video/' + video_id + video_qs + '" style="' +
        styleAttr + '" ' + (video_allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
...
tarteaucitron.services.xiti = {
  ...
  "js": function () {
    ...
    Xt_i += "&hl=" + Xt_h.getHours() + "x" + Xt_h.getMinutes() + "x" +
      Xt_h.getSeconds();
    if (parseFloat(navigator.appVersion) >= 4) {
      Xt_s = screen;
      Xt_i += "&r=" + Xt_s.width + "x" + Xt_s.height + "x" + Xt_s.pixelDepth +
        "x" + Xt_s.colorDepth;
    }

    div.innerHTML = Xt_i + "&ref=" +
  ...
  "fallback": function () {
    ...
    tarteaucitron.addScript(tarteaucitron.user.atLibUrl, "", function () {
      ...
      if (typeof window.tag.privacy !== "undefined") {
        ...
        if (
          visitorMode !== null && visitorMode.name !== undefined &&
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["youtube_playlist_player"], function (x) {
      var frame_title = tarteaucitron.getElemAttr(x, "title") ||
        ...
        video_frame,
        allowfullscreen = tarteaucitron.getElemAttr(x, "allowfullscreen"),
        params = "theme=" + tarteaucitron.getElemAttr(x, "theme") + "&rel=" +
          tarteaucitron.getElemAttr(x, "rel") + "&controls=" +
          tarteaucitron.getElemAttr(x, "controls") + "&showinfo=" +
          tarteaucitron.getElemAttr(x, "showinfo") + "&autoplay=" +
          tarteaucitron.getElemAttr(x, "autoplay") + "&mute=" +
      ...
      video_frame = '<iframe title="' + frame_title + '" style="' + styleAttr +
        ...
        playlist_id + "&" + params + '"' + (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
        "></iframe>";
      return video_frame;
...
tarteaucitron.services.kameleoon = {
  ...
  "js": function () {
    ...
    if (tarteaucitron.user.kameleoon !== undefined) {
      tarteaucitron.addScript(
        "https://" + tarteaucitron.user.kameleoon +
...
tarteaucitron.services.issuu = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["issuu_player"], function (x) {
      ...
      if (issuu_id.match(/\d+\/\d+/)) issuu_embed = "#" + issuu_id;
      else if (issuu_id.match(/d=(.*)&u=(.*)/)) issuu_embed = "?" + issuu_id;

      issuu_frame = '<iframe title="' + frame_title + '" style="' + styleAttr +
        '" src="//e.issuu.com/embed.html' + issuu_embed + '"></iframe>';
...
tarteaucitron.services.matterport = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["matterport"], function (x) {
      ...
      matterport_frame = '<iframe title="' + frame_title + '" style="' +
        styleAttr + '" src="https://my.matterport.com/show/?m=' +
        matterport_id + "&utm_source=hit-content" + matterport_parameters +
...
tarteaucitron.services.activecampaign = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://trackcmp.net/visit?actid=" + tarteaucitron.user.actid + "&e=" +
...
tarteaucitron.services.tawkto = {
  ...
  "js": function () {
    ...
    tarteaucitron.user.tawktoWidgetId = tarteaucitron.user.tawktoWidgetId ||
      "default";
    ...
    tarteaucitron.addScript(
      "https://embed.tawk.to/" + tarteaucitron.user.tawktoId + "/" +
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://get.smart-data-systems.com/gq?site_id=" +
        tarteaucitron.user.getguanty + "&consent=1",
    );
  },
  "fallback": function () {
    "use strict";
    ...
    tarteaucitron.addScript(
      "https://get.smart-data-systems.com/gq?site_id=" +
        tarteaucitron.user.getguanty + "&notrack=1",
    );
  },
};
...
tarteaucitron.services.emolytics = {
  ...
  "js": function () {
    ...
    scriptEmolytics.text = 'var getsmily_id="' +
      tarteaucitron.user.emolyticsID + '";';
...
tarteaucitron.services.adobeanalytics = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "//assets.adobedtm.com/launch-" + tarteaucitron.user.adobeanalyticskey +
        ".min.js",
    );
  },
};
...
tarteaucitron.services.ausha = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["ausha_player"], function (x) {
      ...
      var src = "https://player.ausha.co/index.html?podcastId=" + podcast_id +
        "&v=3";

      if (useshowid == "1") {
        src = "https://player.ausha.co/index.html?showId=" + podcast_id +
          "&v=3";
      }
      ...
      return '<iframe title="' + frame_title + '" id="' + player_id +
        '" loading="lazy" style="width:100%;height:' +
        tarteaucitron.getStyleSize(player_height) + ';" src="' + src +
        '"></iframe>';
    });
...
tarteaucitron.services.visiblee = {
  ...
  js: function () {
    ...
    tarteaucitron.addScript(
      "//www.link-page.info/tracking_" + tarteaucitron.user.visibleeclientid +
        ".js",
      "visiblee",
    );
  },
...
tarteaucitron.services.bandcamp = {
  ...
  js: function () {
    ...
    tarteaucitron.fallback(["bandcamp_player"], function (x) {
      ...
      var src = "https://bandcamp.com/EmbeddedPlayer/album=" + album_id + "/" +
        params;

      return '<iframe title="' + frame_title + '" src="' + src + '" style="' +
        styleAttr + '" allowfullscreen seamless></iframe>';
    });
  },
  fallback: function () {
    "use strict";
...
tarteaucitron.services.acast = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["acast_embed"], function (x) {
      ...
      var widgetURL = "https://embed.acast.com/" + id + "/" + id2 + "?seek=" +
        seek;
      ...
      return '<iframe title="' + frame_title + '" src="' + widgetURL +
        '" style="border: none; overflow: hidden;' + styleAttr + '"></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["mixcloud_embed"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        ...
        hidecover + "&mini=" + mini + "&light=" + light + "&feed=" + id +
        '"></iframe>';
    });
  },
  "fallback": function () {
...
tarteaucitron.services.gagenda = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["gagenda_embed"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" loading="lazy" style="' +
        styleAttr +
        'border-width:0" src="https://www.google.com/calendar/embed?' +
        calendar_data + '"></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.gdocs = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["gdocs_embed"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        '" src="https://docs.google.com/document/d/e/' + id +
...
tarteaucitron.services.gsheets = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["gsheets_embed"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        '" src="https://docs.google.com/spreadsheets/d/e/' + id +
        "/pubhtml?widget=true&amp;headers=" + headers + '"></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.gslides = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["gslides_embed"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        '" src="https://docs.google.com/presentation/d/e/' + id +
        "/embed?start=" + autostart + "&loop=" + loop + "&delayms=" + delay +
...
tarteaucitron.services.gforms = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["gforms_embed"], function (x) {
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        '" src="https://docs.google.com/forms/d/e/' + id +
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["canalu_player"], function (x) {
      ...
      return '<div style="position:relative;padding-bottom:56.25%;padding-top:10px;height:0;overflow:hidden;">' +
        '<iframe title="' + frame_title + '" src="' + frame_url +
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["webtvnu_player"], function (x) {
      var frame_title = (tarteaucitron.getElemAttr(x, "title"))
        ...
        frame_url = "https://webtv.normandie-univ.fr/permalink/" +
          tarteaucitron.getElemAttr(x, "videoID") + "/iframe/",
        width = tarteaucitron.getElemAttr(x, "width"),
        height = tarteaucitron.getElemAttr(x, "height");
      ...
      return '<iframe title="' + frame_title + '" style="' + styleAttr +
        '" src="' + frame_url + '" allowfullscreen allow="autoplay"></iframe>';
    });
  },
  "fallback": function () {
    "use strict";
...
tarteaucitron.services.meteofrance = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_meteofrance"], function (x) {
      ...
      return '<iframe title="' + frame_title +
        '" src="https://meteofrance.com/widget/prevision/' + insee +
        '" style="' + styleAttr + '" allowtransparency ' +
        (allowfullscreen == "0"
          ? ""
          : " webkitallowfullscreen mozallowfullscreen allowfullscreen") +
...
tarteaucitron.services.m6meteo = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["tac_m6meteo"], function (x) {
      ...
      return '<div id="cont_' + id + '"><div id="spa_' + id + '"><a id="a_' +
        id +
...
tarteaucitron.services.archive = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["archive_player"], function (x) {
      ...
      video_frame = '<iframe title="' + frame_title +
        '" src="https://archive.org/embed/' + video_id + '" style="' +
        styleAttr +
...
tarteaucitron.services.gallica = {
  ...
  "js": function () {
    ...
    tarteaucitron.fallback(["gallica_player"], function (x) {
      ...
      frame = '<iframe title="' + frame_title + '" style="' + style +
        '" src="' + src + '"></iframe>';
      return frame;
    });
  },
...
tarteaucitron.services.facebookcustomerchat = {
  ...
  "js": function () {
    ...
    tarteaucitron.addScript(
      "https://connect.facebook.net/" + tarteaucitron.getLocale() +
