...
var tarteaucitron = {
  ...
  init: function (params) {
    ...
    if (tarteaucitron.events.init) tarteaucitron.events.init();
  },
  initEvents: {
    loadEvent: function (isOldBrowser) {
      ...
      tarteaucitron.fallback(["tarteaucitronOpenPanel"], function (elem) {
        ...
        } else {elem.addEventListener("click", function (event) {
            tarteaucitron.userInterface.openPanel();
            event.preventDefault();
          }, false);}
      }, true);
    ...
    keydownEvent: function (isOldBrowser, evt) {
      if (evt.keyCode === 27) tarteaucitron.userInterface.closePanel();
      if (isOldBrowser) {
      ...
      if (tacAlertBig && !tarteaucitron.highPrivacy) {
        if (tacAlertBig.style.display === "block") {
          ...
          if (tacPercentage) {
            ...
            } else tacPercentage.style.bottom = heightPosition;
  ...
  load: function () {
    "use strict";
    if (tarteaucitronIsLoaded === true) return;
    var cdn = tarteaucitron.cdn,
      language = tarteaucitron.getLanguage(),
      useMinifiedJS =
        new URL(cdn, tarteaucitronPath).host == "cdn.jsdelivr.net" ||
        tarteaucitronPath.indexOf(".min.") >= 0 || tarteaucitronUseMin !== "",
    ...
    if (tarteaucitron.parameters.googleConsentMode === true) {
      ...
      document.addEventListener("googleads_added", function () {
        if (tarteaucitron.added["gcmads"] === true) return;
    ...
    tarteaucitron.addInternalScript(pathToLang, "", function () {
      ...
      tarteaucitron.addInternalScript(pathToServices, "", function () {
        if (tarteaucitron.orientation === "middle") {
          ...
          } else {customThemeMiddle.appendChild(
        ...
        if (tarteaucitron.orientation === "popup") {
          ...
          } else {customThemePopup.appendChild(
        ...
        if (tarteaucitron.parameters.mandatory == true) {
          ...
          } else {html += '   <span class="asCatToggleBtn">' +
        ...
        if (
          ...
          if (tarteaucitron.parameters.highPrivacy) {
            html += "       " + tarteaucitron.lang.alertBigPrivacy;
          } else {html += "       " + tarteaucitron.lang.alertBigClick + " " +
              tarteaucitron.lang.alertBig;}
          html += "   </span>";
          html += '   <button aria-label="' + tarteaucitron.lang.icon + " : " +
        ...
        setTimeout(function () {
          ...
          if (tarteaucitron.events.load) tarteaucitron.events.load();
        }, 500);
      });
    });
  },
  addService: function (serviceId) {
    ...
    if (
      ...
      if (
        ...
        if (true === state && typeof service.js === "function") service.js();
        else if (typeof service.fallback === "function") service.fallback();
      }
      ...
      if ("wait" === state) tarteaucitron.userInterface.openAlert();
    }
  ...
  sendEvent: function (event_key) {
    if (event_key !== undefined) {
      var send_event_item;
      if (typeof Event === "function") send_event_item = new Event(event_key);
      else if (typeof document.createEvent === "function") {
  ...
  cleanArray: function cleanArray(arr) {
    ...
    for (i = 0; i < len; i += 1) {
      if (!obj[arr[i]]) {
        obj[arr[i]] = {};
        if (tarteaucitron.services[arr[i]] !== undefined) out.push(arr[i]);
      }
    }
  ...
  userInterface: {
    ...
    color: function (key, status) {
      ...
      if (key !== "") {
        ...
        } else tarteaucitron.cookie.checkCount(key);
      }
      var cats = document.querySelectorAll(
        '[id^="tarteaucitronServicesTitle_"]',
      );
    ...
    closePanel: function () {
      ...
      if (tarteaucitron.reloadThePage === true) window.location.reload();
      else {tarteaucitron.userInterface.css(
          "tarteaucitronBack",
          "display",
          "none",
        );}
    ...
    focusTrap: function (parentElement) {
      ...
      for (var i = 0, max = focusableEls.length; i < max; i++) {
        if (focusableEls[i].offsetHeight > 0) filtered.push(focusableEls[i]);
      }
    ...
    jsSizing: function (type) {
      ...
      if (type === "box") {
        ...
        if (
          ...
          if (e[a + "Width"] <= 479) {}
          else if (e[a + "Width"] <= 767) scrollbarMarginRight = 12;
          scrollbarWidthParent =
        ...
        if (document.getElementById("tarteaucitron") !== null) {
          if (e[a + "Width"] <= 767) mainTop = 0;
          else {mainTop = (windowInnerHeight -
  ...
  cookie: {
    ...
    create: function (key, status) {
      ...
      if (tarteaucitronForceExpire !== "") {
        if (
          ...
          } else timeExpire = tarteaucitronForceExpire * 36e5;
        }
      }
      var d = new Date(),
        time = d.getTime(),
    ...
    checkCount: function (key) {
      ...
      var arr = tarteaucitron.services[key].cookies,
        ...
        cookieLabel = "cookie";
      if (tarteaucitron.getLanguage() === "de") cookieLabel = "Cookie";
      if (status >= 0 && nb === 0) html += tarteaucitron.lang.useNoCookie;
        ...
        if (nbCurrent > 0) {
          html += tarteaucitron.lang.useCookieCurrent + " " + nbCurrent + " " +
            cookieLabel;
          if (nbCurrent > 1) html += "s";
          html += ".";
        } else html += tarteaucitron.lang.useNoCookie;
      } else if (nb === 0) html = tarteaucitron.lang.noCookie;
      else {
  ...
  getLanguage: function () {
    ...
    if (availableLanguages.indexOf(userLanguage) !== -1) return userLanguage;
  ...
  getLocale: function () {
    ...
    var lang = navigator.language || navigator.browserLanguage ||
        navigator.systemLanguage || navigator.userLang || null,
      userLanguage = lang ? lang.substr(0, 2) : null;
    if (userLanguage === "fr") return "fr_FR";
    else if (userLanguage === "en") return "en_US";
    else if (userLanguage === "de") return "de_DE";
    else if (userLanguage === "es") return "es_ES";
    else if (userLanguage === "it") return "it_IT";
    else if (userLanguage === "pt") return "pt_PT";
    else if (userLanguage === "nl") return "nl_NL";
    else if (userLanguage === "el") return "el_EL";
    else return "en_US";
  },
  addScript: function (
    url,
    ...
    if (execute === false) { if (typeof callback === "function") callback(); }
    else {
      script = document.createElement("script");
      if (id !== undefined && id !== "") script.id = id;
      script.async = true;
      script.src = url;
  ...
  fallback: function (matchClass, content, noInner) {
    ...
    for (var i = 0; i < elems.length; i++) {
      ...
      if (width !== "") elem.style.width = tarteaucitron.getStyleSize(width);
      if (height !== "") elem.style.height = tarteaucitron.getStyleSize(height);
      if (typeof content === "function") {
        if (noInner === true) content(elem);
        else elem.innerHTML = content(elem);
  ...
  extend: function (a, b) {
    "use strict";
    var prop;
    for (prop in b) if (b.hasOwnProperty(prop)) a[prop] = b[prop];
  },
  proTemp: "",
  proTimer: function () {
    "use strict";
  ...
  addClickEventToElement: function (e, func) {
    if (e) {
      if (e.addEventListener) e.addEventListener("click", func);
      else e.attachEvent("onclick", func);
    }
  },
